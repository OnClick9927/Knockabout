...
namespace GamePlay
{
    static class HashCodeExtension
    {
        public static int GetHash(this Property val, ref int idx)
        {
            return val.value.GetHash(ref idx) + val.type.GetHash(ref idx);
        }
        ...
        public static int GetHash(this float val, ref int idx)
        {
            return (int)val;
        }
        ...
        public static int GetHash(this Lockstep.Random val, ref int idx)
        {
            return val.randSeed.GetHash(ref idx);
        }
        ...
        public static int GetHash(this Enum val, ref int idx)
        {
